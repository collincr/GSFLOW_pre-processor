...
#    # ====================================================================
    ...
    hydcond1 = np.copy(hydcond[:,:,0])
    hydcond1[TOP>250] = 0.0001
    hydcond2 = np.copy(hydcond[:,:,1])
#    hydcond2(TOP>250) = 0.01
...
#    # ====================================================================
    ...
    hydcond1 = np.copy(hydcond[:,:,0])
    hydcond1[TOP<125] = 0.3
    hydcond1[TOP<75] = 0.5
    hydcond1[TOP>200] = 0.0001
    hydcond2 = np.copy(hydcond[:,:,1])
#    hydcond2[TOP>200] = 0.0001
#    hydcond2(TOP>250) = 0.01
...
#    finf[:] = 8.8e-6    
#    finf[:] = 8.8e-4    # this worked pretty well, night 10/1

#    finf[:] = 8.8e-2    # best?
    finf[:] = 2*8.8e-2    # best? but then too much sat water loss... I think too much water!
#    finf[:] = 8.8e-1    # not so good again

#    finf[:] = 8.8e-5    # pretty good <~5% error
#    finf[:] = 1.8e-5    # pretty good <~5% error usually
    finf[:] = 4.8e-5    # pretty good <~5% error usually
